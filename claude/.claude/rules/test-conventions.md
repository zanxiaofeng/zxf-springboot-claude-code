...
For comprehensive API test conventions including naming, fixtures, templates, support class reference, WireMock patterns, assertion system, and checklists, see `.claude/rules/apitest-guide.md`.